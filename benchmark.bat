...
rem go test %1 -bench=%2 --benchtime 4s -cpuprofile=.\test_temp\%1_cpu.prof -memprofile=.\test_temp\%1_mem.prof %3 
go test %1 -bench=%2  -cpuprofile=.\test_temp\%1_cpu.prof -memprofile=.\test_temp\%1_mem.prof %3 
